...
import 'package:advanced_todo/database_helper.dart';
...
class _TODOAppUIState extends State<TODOAppUI> {
  ...
  void removeTasks(ToDoModelClass toDoModelObject) {
    db.deleteTask(toDoModelObject);
  }

  void getList() async {
    db.initializeDB();
    listTasks = await db.getTaskList();
    setState(() {});
  }
  ...
  void submit(bool doEdit, [ToDoModelClass? toDoModelObject]) async {
    if (titleController.text.trim().isNotEmpty &&
      ...
      //   });
        ...
        toDoModelObject.title = titleController.text.trim();
        toDoModelObject.description = descriptionController.text.trim();
        await db.updateTask(toDoModelObject);
        getList();
      }
    }
    clearControllers();
  ...
  Future<void> showBottomSheet(bool doEdit,
      [ToDoModelClass? toDoModelObject]) async {
